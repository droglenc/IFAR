...
source("../modHTML.R"); modHTML("ComplexLayouts")
...
```{r echo=-c(1:10), results='hide', fig.width=2*figsz, fig.height=2*figsz}
# ############################################################
# This code is a repeat of the code immediately above and is
# only used to efficiently produce the plot for the supplement.
<<Layout2pre>>
...
`r figcaps("Layout4",display="cite")`
...
`r figcaps("Layout5",display="cite")`
