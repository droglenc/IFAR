...
The von Bertalanffy Growth Function (VBGF) was introduced and methods for fitting the function were illustrated in Chapter 12 of the [*Introductory Fisheries Analyses with R*](http://derekogle.com/IFAR/) (IFAR) book.  That description used one common nonlinear model fitting algorithm.  Alternative algorithms for fitting nonlinear models are introduced here.  Other supplements demonstrate how to [fit other parameterizations of the VBGF](OtherVBGFParams.html) and [other growth functions](OtherGrowthFuns.html).
