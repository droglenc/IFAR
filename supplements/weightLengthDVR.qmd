...
These results show, for example, the mean $log_{10}(W)$ for when $log_{10}(L)$=`r formatC(mean(ruf2$logL),format="f",digits=6)` for fish captured in 1992 is `r formatC(cis$emmeans[1,"emmean"],format="f",digits=6)`.
