...
1. Compare your results using the "classical" method here to your results from using the Isermann and Knight (2007) method in [this exercise](LORockBass_ALK_B.html) (assuming that you completed that exercise).
