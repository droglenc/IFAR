...
1. Statistically compare the following metrics between Yellow Perch captured in the the `inner` and `outer` portions of Saginaw Bay.
    1. The length frequency distributions.
