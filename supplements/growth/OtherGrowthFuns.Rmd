...
The von Bertalanffy Growth Function (VBGF) was introduced and methods for fitting the model were illustrated in Chapter 12 of the [*Introductory Fisheries Analyses with R*](http://derekogle.com/IFAR/) (IFAR) book.  Other growth functions exist and are illustrated in this supplement.  Other supplements demonstrate how to [fit other parameterizations of the VBGF](OtherVBGFParams.html) and [use alternative nonlinear model fitting algorithms](OtherNLAlgorithms.html).
