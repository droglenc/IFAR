...
source("../../rhelpers/IFARhelpers.R"); modHTML("CommonAxisLabels")
...
A common need is to plot multiple graphics in a grid-like format with one axis label that serves as the label for each graph.  This can be accomplished with arguments to `par()`, but the regions of a plot must be undersood first (the following description is modified [from here](http://research.stowers-institute.org/efg/R/Graphics/Basics/mar-oma/index.htm)).
...
```{r echo=FALSE, fig.width=figsz, fig.height=figsz}
# ############################################################
