...
Weights (g) and total lengths (mm) from Ruffe (*Gymnocephalus cernuus*) captured in the St. Louis River Harbor (Minnesota and Wisconsin) were used in Chapter 7 of **IFAR** and will also be used in this supplement.  These data are from @OgleWinfield2009 and are in `RuffeSLRH.csv` ([view](https://github.com/droglenc/FSA/blob/master/data-raw/RuffeSLRH.csv), [download](https://raw.githubusercontent.com/droglenc/FSA/master/data-raw/RuffeSLRH.csv), [meta-data](http://derekogle.com/fishR/data/data-html/RuffeSLRH.html)).  To eliminate within-season variability, only Ruffe captured in July are used here.  Additionally,  a factored version of `year` was created, the common logarithms of weight and length were created, and the `fishID`, `month`, and `day` variables were removed to save space in the output.
```{r message=FALSE}
