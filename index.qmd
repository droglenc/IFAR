...
1. **Plotting Fundamentals**
    ...
    * [R Script](scripts/Plotting.R) and Data: 
...
1. **Weight-Length Relationships**
    ...
    * Supplements: [DVR with More than Two Groups](supplements/weightlength/index.html)
...
1. **Individual Growth**
    ...
    * Supplements: [Fitting Other VBGF Parameterizations](supplements/growth/OtherVBGFParams.html), [Fitting Other Growth Functions](supplements/growth/OtherGrowthFuns.html), [Additional Nonlinear Regression Algorithms](supplements/growth/OtherNLAlgorithms.html)
...
1. **Recruitment**
    ...
    * Supplements: [Maturity Schedules](supplements/maturity/index.html)
