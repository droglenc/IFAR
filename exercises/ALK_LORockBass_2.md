...
1. Separate the observed data into age- and length-samples.  Construct an **observed** age-length key from the table above (using R).  [These would have been accomplished in [This is a continuation of this exercise.](ALK_LORockBass_1.html).]
